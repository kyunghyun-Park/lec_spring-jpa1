...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Item item = createBook("토비의 스프링1", 20000, 10);
    ...
    @Test(expected = NotEnoughStockException.class) //재고수량 초과하면 해당 exception 터져야함
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals("주문이 취소된 상품은 그만큼 재고가 원복되야 한다.", 10, item.getStockQuantity());
